    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="手机号码" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="请输入手机号码" maxlength="11" :readonly="!isAdd">
                <template #suffix>
                  <el-link v-if="!isAdd" type="primary" :underline="false" @click="onEditPhone">编辑</el-link>
                </template>
              </el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    /** 提交按钮 */
    submitForm: function() {
      this.form.phonenumber = this.form.phonenumber.includes('*')?null:this.form.phonenumber
